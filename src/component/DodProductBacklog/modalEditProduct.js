...
import FormEditDodProduct from "./formEditProduct.js";

export default function ModalEditDodProduct(props) {
  const setOpen = () => {
    props.setOpen(false);
  };

  const handleAdd = (judul, target, satuan) => {
    props.editData(judul, target, satuan);
  };
  return (

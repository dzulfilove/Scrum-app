...
import FormEditPBIProduct from "./formEditProduct.js";

export default function ModalEditPBIProduct(props) {
  const setOpen = () => {
    props.setOpen(false);
  };

  const handleAdd = (judul, target, alasan, perspektif, jenis) => {
    props.editData(judul, target, alasan, perspektif, jenis);
  };
  return (
              ...
              <div className="flex items-start">
                <div className=" text-center w-full  ">
                  <div className=" w-full flex justify-center">
                    ...
                    >
                      Update Data PBI Product
                    </DialogTitle>
                  </div>
                  <div className=" px-4">
                    <FormEditPBIProduct data={props.data} addData={handleAdd} />
                  </div>
                </div>
              </div>
            </div>

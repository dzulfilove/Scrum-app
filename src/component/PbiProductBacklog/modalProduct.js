...
import FormAddPBIProduct from "./formAddProduct";

export default function ModalAddPBIProduct(props) {
  const setOpen = () => {
    props.setOpen(false);
  };
              ...
              <div className="flex items-start">
                <div className=" text-center w-full  ">
                  <div className=" w-full flex justify-center">
                    ...
                    >
                      Tambah Data PBI Product
                    </DialogTitle>
                  </div>
                  <div className=" px-4">
                    <FormAddPBIProduct addData={handleAdd} />
                  </div>
                </div>
              </div>
            </div>

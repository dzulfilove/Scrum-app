...
import FormAddProduct from "./formAddSprint.js";
import FormEditProduct from "./formEditDodSprint.js";
import FormEditPBIProduct from "./formEditDodSprint.js";
import FormEditDodProduct from "./formEditDodSprint.js";
import FormEditDodSprint from "./formEditDodSprint.js";

export default function ModalEditDodSprint(props) {
  const setOpen = () => {
    props.setOpen(false);
  };

  const handleAdd = (target, dod) => {
    props.editData(target, dod);
  };
  return (

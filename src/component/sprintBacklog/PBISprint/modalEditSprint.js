...
import FormEditPBISprint from "./formEditSprint.js";

export default function ModalEditPBISprint(props) {
  const setOpen = () => {
    props.setOpen(false);
  };

  const handleAdd = (target, plan, product) => {
    props.editData(target, plan, product);
  };
  return (

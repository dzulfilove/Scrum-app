...
import FormAddPBIProduct from "./formAddPBISprint";
import FormAddPBISprint from "./formAddPBISprint";

export default function ModalAddPBISprint(props) {
  const setOpen = () => {
    props.setOpen(false);
  };

  const handleAdd = (target, plan, product) => {
